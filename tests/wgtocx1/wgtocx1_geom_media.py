...
def set_GeometryAndMedia(qwm_doc):
    ...
    qwm_doc.sketch_waveguid.Placement = FreeCAD.Placement(FreeCAD.Vector(0.0,0.0,0.0),FreeCAD.Rotation(0.5,0.0,0.0,0.0))
    ...
    qwm_doc.sketch_antenna.Placement = FreeCAD.Placement(FreeCAD.Vector(0.0,0.0,3.0),FreeCAD.Rotation(0.5,0.0,0.0,0.0))
    ...
    qwm_doc.sketch_coaxair.Placement = FreeCAD.Placement(FreeCAD.Vector(0.0,0.0,5.0),FreeCAD.Rotation(0.5,0.0,0.0,0.0))
