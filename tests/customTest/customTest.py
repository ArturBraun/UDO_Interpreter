...
#sys.path.append("..\tests\customTest\")
#sys.path.insert(0, '..\tests\customTest\')

from customTest_proj import *
...
qwm_doc = QW_Modeller.newQWDocument("customTest")

FreeCADGui.activeDocument().activeView().viewAxometric()

proj = customTest_Project(qwm_doc)
