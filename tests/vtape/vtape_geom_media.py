...
def set_GeometryAndMedia(qwm_doc):
    ...
    qwm_doc.sketch_vtape.Placement = FreeCAD.Placement(FreeCAD.Vector(0.0,0.0,0.0),FreeCAD.Rotation(0.0, 0.0, 0.0, 1.0))
    ...
    qwm_doc.sketch_vtape1.Placement = FreeCAD.Placement(FreeCAD.Vector(0.0,0.0,30.0),FreeCAD.Rotation(0.0, 0.0, 0.0, 1.0))
